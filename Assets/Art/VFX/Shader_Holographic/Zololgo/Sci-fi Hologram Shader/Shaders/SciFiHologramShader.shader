	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
                ...
                o.color = _Color*max(0,lerp(1,(0.5-fresnel_dissolve),_Fade*1.0)) + lerp(0,smoothstep(1 - _RimFalloff, 1.0, fresnel_rim), _RimStrenght) * _RimColor * 2.0;		
				return o;
			}
